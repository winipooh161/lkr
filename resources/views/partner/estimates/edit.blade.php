...
<link href="{{ asset('css/estimates/excel-editor.css') }}?v={{ time() }}" rel="stylesheet">
<link href="{{ asset('css/estimates/excel-editor-optimized.css') }}?v={{ time() }}" rel="stylesheet">
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12" style="h">
            @include('partner.estimates.partials.excel-editor')
        </div>
        <div class="col-md-12 mb-3" style="h">
            @include('partner.estimates.partials.estimate-info-form')
        </div>
    </div>
</div>
...
<script src="{{ asset('js/estimates/excel-formula-manager-fixed.js') }}?v={{ time() }}"></script>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        if (typeof initExcelEditor === 'function') {
            ...
            if (estimateId) {
                var dataUrl = "{{ route('partner.estimates.getData', ['estimate' => $estimate->id ?? 0]) }}";
